...
namespace YW.Common.Http
{
    ...
    public class HttpHelper
    {
        ...
        public static string GetHtml(string Url)
        {
            ...
            HttpItem myHttpItem = new HttpItem();
            myHttpItem.UserAgent = "Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/54.0.2840.71 Safari/537.36";
            myHttpItem.Allowautoredirect = true;
            myHttpItem.URL = Url;

            Uri i = new Uri(Url);
            myHttpItem.Referer = i.Scheme + "://" + i.Host;
            return http.GetHtml(myHttpItem).Html;
        }
