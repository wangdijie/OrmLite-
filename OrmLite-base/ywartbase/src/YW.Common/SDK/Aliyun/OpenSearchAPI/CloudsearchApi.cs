...
namespace AliCloud.com.API
{
    ...
    public class CloudsearchApi
    {
        ...
        private const string SDK_VERSION = "2.1.1";
        ...
        public CloudsearchApi(string clientId, string clientSecret, string host = null, int mode = 0, string signatureMethod = "HMAC-SHA1",
        ...
        public string _makeSign(Dictionary<String, Object> parameter)
        {
        ...
        /// <param name="parameter">参数数组</param>
        /// <returns>签名字符串</returns>
        public string _makeSignAliyun(Dictionary<String, Object> parameter, String method)
        {
            string q = string.Empty;
            String sign_mode = string.Empty;
        ...
        /// <returns>字符串</returns>
        public string buildParams(Dictionary<String, Object> parameters)
        {
